...
Device::Device(VkSurfaceKHR surface, VulkanInstance& instance)
	: m_Surface(surface)
...
void Device::PickPhysicalDevice() 
{
    ...
    vkEnumeratePhysicalDevices(m_InstanceRef.GetInstance(), &deviceCount, nullptr);
    if (deviceCount == 0) {
...
void Device::CreateLogicalDevice() 
{
    ...
    if (enableValidationLayers) {
        createInfo.enabledLayerCount = static_cast<uint32_t>(m_InstanceRef.GetValidationLayers().size());
        createInfo.ppEnabledLayerNames = m_InstanceRef.GetValidationLayers().data();
    }
    else {
...
Device::QueueFamilyIndices Device::FindQueueFamilies(VkPhysicalDevice physicalDevice)
{
...
Device::SwapChainSupportDetails Device::QuerySwapChainSupport(VkPhysicalDevice physicalDevice)
{
